        ...
        >
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-2xl font-bold text-[#252940]">
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            ...
            >
              ...
              <textarea
                ...
                className="w-full border-2 border-gray-200 rounded-2xl p-4 h-32 focus:ring-4 focus:ring-[#00c977]/20 focus:border-[#00c977] outline-none transition-all duration-300 resize-none bg-gray-50 focus:bg-white"
